...
CSystemTray::CSystemTray(CWnd* pParent,             // The window that will recieve tray notifications
                         ...
                         LPCTSTR szBalloonTip /*=nullptr*/,    // Ballon tip (w2k only)
                         LPCTSTR szBalloonTitle /*=nullptr*/,  // Balloon tip title (w2k)
...
bool CSystemTray::Create(CWnd* pParent, UINT uCallbackMessage, LPCTSTR szToolTip, 
                         ...
                         LPCTSTR szBalloonTip /*=nullptr*/, 
                         LPCTSTR szBalloonTitle /*=nullptr*/,  
                         ...
                         UINT uBalloonTimeout /*=10*/)
{
    ...
    CWnd::CreateEx(0, AfxRegisterWndClass(0), _T(""), WS_POPUP, 0,0,0,0, nullptr, 0);
...
{
    return (m_bEnabled)? m_tnd.hIcon : nullptr;
}
...
bool CSystemTray::Animate(UINT nDelayMilliSeconds, int nNumSeconds /*=-1*/)
{
	...
	m_uIDTimer = SetTimer(m_nTimerID, nDelayMilliSeconds, nullptr);
...
LRESULT CSystemTray::OnTrayNotification(WPARAM uID, LPARAM lParam)
{
    ...
    {    
        ...
        ::TrackPopupMenu(pSubMenu->m_hMenu, 0, pos.x, pos.y, 0, 
                         pTargetWnd->GetSafeHwnd(), nullptr);
#else
        pSubMenu->TrackPopupMenu(TPM_LEFTALIGN, pos.x, pos.y, pTargetWnd, nullptr);
#endif
...
void CSystemTray::SetCustomizeMenuCallback(fnCustomizeMenuCallback_t callback)
{
	m_fnCustomizeMenuCallback = callback;
}

void CSystemTray::CustomizeMenu(CMenu &Menu_in_out)
{
	if (m_fnCustomizeMenuCallback != nullptr)
	{
		m_fnCustomizeMenuCallback(Menu_in_out);
	}
}
...
void CSystemTray::MaximiseFromTray(CWnd* pWnd, bool bForceAnimation /*= true*/)
{
    ...
    pWnd->RedrawWindow(nullptr, nullptr, RDW_UPDATENOW | RDW_ALLCHILDREN | RDW_FRAME |
