...
CImageListButton::CImageListButton() : m_bFlat(false), m_OriginalStyle(0U), m_bChecked(false),
	...
	m_bRadio(false), m_bPressed(false), m_bHighlight(false), m_pToolTip(nullptr),
	m_pImageList(nullptr), m_ImageIndex(0), m_pDisabledBrush(nullptr)
{
...
void CImageListButton::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct_in)
{
	...
	if (m_pImageList != nullptr && m_ImageRect.IsRectEmpty() == FALSE)
	{
...
{
	// if lParam is nullptr, it means GetIcon/GetBitmap/GetCursor
