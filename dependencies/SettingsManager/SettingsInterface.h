...
namespace Settings
{
	...
	public:
		...
		*/
		virtual void SetLong(const string_t &SectionName_in, const string_t &Key_in, LONG NewValue_in, const TCHAR *pComment_in = nullptr) =0;
		...
		*/
		...
		/*! \brief Sets the specified key value as string in the specified section
			...
			\param[in] NewValue_in : the new value for the key
		*/
		virtual void SetString(const string_t &SectionName_in, const string_t &Key_in, const string_t &NewValue_in, const TCHAR *pComment_in = nullptr) =0;
	};
}
