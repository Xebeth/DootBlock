...
namespace Settings
{
	...
	*/
	...
	{
		return (m_pIni != nullptr && m_pIni->SetValue(SectionName_in.c_str(), nullptr, nullptr));
	}
	...
	*/
	...
	{
		return (m_pIni != nullptr && m_pIni->Delete(SectionName_in.c_str(), nullptr));
	}
	...
	*/
	...
	/*! \brief Retrieves all the key/value pairs from the specified section
		\param[in] SectionName_in : the name of the section to retrieve pairs from
		\return a pointer to the key/value pairs found in the section
	*/
	const CSimpleIni::TKeyVal* SettingsIniFile::GetValues(const string_t &SectionName_in)
	{
		return m_pIni->GetSection(SectionName_in.c_str());
	}
	...
	*/
	...
	{
		return (m_pIni != nullptr) ? m_pIni->SectionExists(SectionName_in.c_str()) : false;
	}
	...
	*/
	...
	{
		return (m_pIni != nullptr) ? m_pIni->KeyExists(SectionName_in.c_str(), KeyName_in.c_str()) : false;
	}
	...
	*/
	...
	{
		return (m_pIni != nullptr) ? m_pIni->DeleteKey(SectionName_in.c_str(), KeyName_in.c_str()) : false;
	}
